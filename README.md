...
// ...
```
3.Use `swoole_table` to bind FD & UserId, optional. Also you can use the other global storage services, like Redis/Memcached/MySQL, but be careful that FD will be possible same between multiple `Swoole Servers`.
[Swoole Table Demo](https://github.com/hhxsv5/laravel-s/blob/master/README.md#use-swoole_table)
