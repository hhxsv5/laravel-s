...
| Command | Description |
| --------- | --------- |
| `start` | Start LaravelS, list the processes by "*ps -ef&#124;grep laravels*", support command options `-d` or `--daemonize` to run as a daemon |
| `stop` | Stop LaravelS |
| `restart` | Restart LaravelS, support command options `-d` or `--daemonize` |
